  ...
  return (
    <div>
      <Link
        ...
        className="inline-flex items-center gap-1.5 text-sm text-stone-400 hover:text-stone-700 transition-colors mb-6 md:mb-8"
      >
      ...
      <div className="bg-white rounded-2xl md:rounded-3xl border border-stone-100 overflow-hidden shadow-sm">
        <div className="flex items-center justify-between px-5 md:px-7 py-4 md:py-5 border-b border-stone-100">
          <div>
            <h2 className="font-serif text-base md:text-lg text-stone-900">Albümler</h2>
        ...
        {!albums || albums.length === 0 ? (
          <div className="px-6 md:px-7 py-10 md:py-12 text-center">
              ...
              <li key={a.id}>
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <span className="text-sm font-medium text-stone-800 group-hover:text-stone-900 truncate">{a.title}</span>
                  </div>
...
function ActionCard({ href, icon, bg, label, desc }: {
  ...
  return (
    <Link
      href={href}
      className="bg-white rounded-2xl border border-stone-100 p-5 md:p-6 hover:border-rose-100 hover:shadow-md shadow-sm transition-all group"
    >
      <div className={`w-10 h-10 md:w-11 md:h-11 ${bg} rounded-xl md:rounded-2xl flex items-center justify-center mb-3 md:mb-4 group-hover:scale-110 transition-transform`}>
        {icon}
      </div>
