    ...
    <section className="relative min-h-screen flex items-center justify-center bg-white px-6 pt-24 pb-16 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto w-full grid md:grid-cols-2 gap-16 items-center">
        <motion.div variants={container} initial="hidden" animate="show">
          <motion.p variants={item} className="text-[11px] tracking-[0.3em] uppercase text-stone-400 mb-6">
          ...
          <motion.div variants={item} className="flex flex-col sm:flex-row gap-3">
            <Link
              href="/register"
              className="inline-flex items-center justify-center gap-2 bg-stone-900 hover:bg-stone-700 text-white text-sm font-semibold px-8 py-4 rounded-full transition-colors"
            >
              Ücretsiz Dene →
            </Link>
            <Link
              href="#how-it-works"
              className="inline-flex items-center justify-center gap-2 border border-stone-200 text-stone-600 hover:border-stone-400 text-sm font-medium px-8 py-4 rounded-full transition-colors"
            >
              Nasıl çalışır?
            </Link>
          </motion.div>
        ...
        >
          <div className="relative">
            <div className="w-64 bg-stone-100 rounded-[2.5rem] p-2.5 shadow-xl shadow-stone-200/60">
            ...
            <motion.div
              ...
              className="absolute -left-16 top-16 bg-white rounded-2xl shadow-lg border border-stone-100 p-3 flex items-center gap-2.5"
            >
              <div className="w-8 h-8 bg-stone-900 rounded-xl flex items-center justify-center text-sm">⬛</div>
              <div>
            ...
            <motion.div
              ...
              className="absolute -right-14 bottom-24 bg-white rounded-2xl shadow-lg border border-stone-100 p-3"
            >
